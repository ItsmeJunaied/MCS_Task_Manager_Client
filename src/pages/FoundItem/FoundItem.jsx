...
const FoundItem = () => {
        ...
        fetch(img_hosting_url, {
            ...
            .then(imgResponse => {
                if (imgResponse.success) {
                    ...
                    const item = { email, Name, ItemName,category, image: imgURL, location, Date, Time, Description };
                    const newData = { ...item, post: 'found', status: 'Not Taken' };
                    console.log(newData);
                    fetch('https://task-manager-server-itsmejunaied.vercel.app/Task', {
                        method: "POST",
                        headers: {
    ...
    return (
        <div>
            <h2 className=" text-center font-bold text-3xl text-teal-600 mt-20"><span className=" text-yellow-500 uppercase">{user?.displayName}</span> Add Found Item</h2>
            <div>
