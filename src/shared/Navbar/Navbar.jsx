...
const Navbar = () => {
    ...
    const navlink = <>
        ...
        <label onClick={()=> handleTheme()} className="swap swap-rotate ml-10">
    ...
    return (
        <div>
            ...
            <div className="navbar bg-[#76965D] text-primary-content">
                <div className="navbar-start">
                    ...
                    <a className="btn btn-ghost normal-case text-xl">Lostify</a>
                </div>
